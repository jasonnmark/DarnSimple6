...
contactIndex = new EasySearch.Index({
  collection: Contacts,
...
*/
	searchOnMe: {
		type: String,
		optional: true,
		// I tried using autoValue, but the udpates were always based on the last thing in the database, not a mix of old and new, so instead I used Collection hooks before.insert and before.update (below)
	},
	archived: {
    	type: Boolean,
    	optional: true
