...
Template.contactSearchBox.onCreated(function contactListOnCreated() {
...
Template.contactSearch.helpers({
	...
	inputAttributes: function () { return { class: 'easy-search-input form-control', name: 'contactSearch', placeholder: 'Add or Find Contacts', autocomplete: 'off' }; },
